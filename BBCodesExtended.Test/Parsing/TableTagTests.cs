...
namespace BBCodesExtended.Parsing.Test
{
    ...
    {
        [TestMethod]
        public void Can_parse_table_tags()
        {
            const string input = "The following text has an empty table [table][/table] to it.";
            const string expected = "The following text has an empty table <table></table> to it.";
        ...
        [TestMethod]
        public void Can_parse_multiple_table_tags()
        {
            const string input = "The following text has multiple [table][/table] empty table [table][/table] to it.";
            const string expected = "The following text has multiple <table></table> empty table <table></table> to it.";
        ...
        [TestMethod]
        public void Can_parse_nested_table_tags()
        {
            const string input = "The following text has nested tables [table][table][/table][/table] to it.";
            const string expected = "The following text has nested tables <table><table></table></table> to it.";
